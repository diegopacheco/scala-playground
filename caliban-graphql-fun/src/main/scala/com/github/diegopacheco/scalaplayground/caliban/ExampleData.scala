...
import com.github.diegopacheco.scalaplayground.caliban.ExampleData.Origin.{BELT, EARTH, MARS}
import com.github.diegopacheco.scalaplayground.caliban.ExampleData.Role.{Captain, Engineer, Mechanic, Pilot}
