# Scala 3.x + Java 25 + Spring Boot 3.5.x + Tomcat + Virtual Threads + Metrics + Grafana + K6
...
**Health & Metrics (Management Port 8182):**
...
└──────────────────┬──────────────────────────────────────────┘
  ...
  └────┬─────┘          └────┬─────┘
       ...
       │                     │
        ...
        │  │  │                                       │  │  │
        │  │  │  ✓ NO BOTTLENECK: Millions of VTs     │  │  │
        │  │  │    possible, blocking is cheap        │  │  │
        │  │  └─────────────┬─────────────────────────┘  │  │
        │  │                │                            │  │
        │  │  ┌─────────────▼─────────────────────────┐  │  │
        │  │  │ Port 8182: Management Endpoints       │  │  │
        ...
        │                   │                               │
        │  ┌────────────────▼────────────────────────────┐  │
        │  │ @Async Components (Virtual Threads)         │  │
        │  │  - CustomHealthIndicator                    │  │
        │  │  - healthCheckExecutor (VT executor)        │  │
        │  │  - slowRequestExecutor (VT executor)        │  │
        │  └────────────────┬────────────────────────────┘  │
        │                   │                               │
        │  ┌────────────────▼────────────────────────────┐  │
...
* https://github.com/diegopacheco/scala-playground/tree/master/scala-3.7-spring-boot-3.5-netty-metrics-grafana-k6
